...
wally is a chat bot built on the [Hubot][hubot] framework. It was
...
This returns a list of all of the cities that can be called by wally.
...
### Running wally Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start wally locally by running:
...
Then you can interact with wally by typing `wally help`.

    wally> wally help
    wally animate me <query> - The same thing as `image me`, except adds [snip]
    wally help - Displays all of the help commands that wally knows about.
    ...
