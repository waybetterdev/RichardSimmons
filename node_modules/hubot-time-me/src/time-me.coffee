...
module.exports = (robot) ->
  ...
  robot.respond /([\w\-]+) will be (.*)/i, (msg) ->
    ...
    setLocationForUser robot, user, location, formattedUnixTime info.timestamp(message) ->
      msg.send message
  ...
  robot.respond /where is ([\w\-]+)/i, (msg) ->
    ...
    if location?
      msg.send "From #{formattedUnixTime info.timestamp} #{user} is #{location.stringLocation} ."
    else
